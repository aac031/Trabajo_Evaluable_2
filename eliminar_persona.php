...
<body>
    ...
    if (isset($_GET['id'])) {
        ...
        $sql = "DELETE FROM contacto_persona WHERE id='" . $id . "'";
        ...
        if ($resultado) {
            echo "<script language='JavaScript'>
                alert('El contacto de persona fue eliminado con éxito.');
                </script>";
        } else {
            echo "<script language='JavaScript'>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo "<a href='eliminar_persona.php?id=" . $filas['id'] . "'>Eliminar contacto</a>"; ?>
                    </td>
                </tr>
            <?php
