...
<body>
    ...
    <table class="minimalistBlack">
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        <!-- Dentro de la tabla meteremos todos los datos que nos muestre las consultas hecha en la linea 61. -->
                ...
                ?>
                    <tr>
                        <!-- Dentro de la tabla meteremos todos los datos que nos muestre las consultas hecha en la linea 91. -->
                        <td><?php echo $filas['nombre'] ?></td>
                    </tr>
            <?php
                    // Cerramos el bucle while
