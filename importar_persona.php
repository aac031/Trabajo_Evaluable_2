...
<body>
    ...
    <br>
    <?php
    // Para la tabla contacto_persona, solo serán importados los datos de los contactos
    // que tengan como atributo tipo persona.
    foreach ($xml->contacto as $datos) {
        $atributo = $datos->attributes();
        // Si el atributo tipo es igual a empresa, los datos se introducirán en la tabla contacto_persona
